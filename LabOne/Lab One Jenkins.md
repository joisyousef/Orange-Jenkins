...
2. Scroll down and select **ThinBackup** under the "Backup Management" section.
	
	 b. Set the Backup Directory:

1. Click **Settings** in the ThinBackup plugin page.
    
2. In the **Backup directory** field, enter:
...
2. Click on **Backup Now** to trigger a manual backup.
    
3. Verify that backups are stored in `/var/lib/jenkins/jenkins_backup`.
